...
### Problem Statements
- Bagaimana cara mengklasifikasikan tingkat obesitas seseorang berdasarkan karakteristik dan kebiasaannya?
- Model machine learning mana yang memberikan hasil terbaik dalam memprediksi tingkat obesitas?

### Goals
- Membangun model machine learning untuk memprediksi tingkat obesitas berdasarkan dataset yang tersedia.
- Membandingkan performa beberapa model untuk memilih yang terbaik.
...
3. Telah melakukan perbandingan 6 model machine learning  yaitu Decision Tree, XGBoost, Random Forest, SVM, Logistic Regression, LightGBM menghasilkan solusi optimal dengan XGBoost Dan melakukan evaluasi model menggunakan metrik yang sesuai serta memilih model terbaik berdasarkan hasil evaluasi akurasi
